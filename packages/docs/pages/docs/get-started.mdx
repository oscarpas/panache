...
It's easy to adapt your components style based on props. To access props we pass a function to the component creator, the function will receive any props you pass in.

```jsx
const MyComponent = panache.div(({ isClicked }) => ({
	color: '#fff',
