...
Server side rendering of styles is supported, exactly how you enable it depends on your SSR framework.

First you need to run `ReactDOMServer.renderToStaticMarkup` which renders your App so Panache can collect all the styles. Pass your entire App tree to as an argument:
