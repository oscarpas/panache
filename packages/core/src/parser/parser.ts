...
import { prefixValue, prefixProperty } from '../prefixer/prefixer'
...
export function parseStyleObject(
  ...
  function pushRule(values: StyleItemValues, media: string | void) {
    ...
    const [prefixedValues, additionalProperties] = prefixValue(property, value)
    const styleItem = {
    ...
    if (Object.keys(additionalProperties).length > 0) {
      const additionalEntries: Array<[string, string]> = Object.entries(additionalProperties)
