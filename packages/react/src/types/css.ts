...
import { ResponsiveVariable } from './panache'

/**
 * Based on: https://github.com/frenic/csstype
 */
...
export interface CssProperties<TLength = (string & {}) | 0, TTime = string & {}>
  extends StandardProperties<TLength, TTime>, SvgProperties<TLength, TTime> {}
...
export interface PropertiesFallback<TLength = (string & {}) | 0, TTime = string & {}>
  extends StandardPropertiesFallback<TLength, TTime>, SvgPropertiesFallback<TLength, TTime> {}
...
export type Globals = "inherit" | "initial" | "revert" | "unset" | ResponsiveVariable;
